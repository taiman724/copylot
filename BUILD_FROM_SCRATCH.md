...
社用 PC で同等の拡張を **手書きで再現** するための段階的ビルド手順書。スマホで読みながらでも、A4 印刷して見ながらでも進められるように構成。
...
**Step 1 が完動すれば最低限の業務利用は可能**。Step 2 まで行くとデフォルトで使い勝手が大きく上がる。Step 3 以降はあると嬉しい上乗せ。
...
VS Code が使えるなら、ファイル全体をコピペできるので圧倒的に楽。社用 PC で何が使えるか事前に把握しておく。
...
これで全機能完備。明日の社用 PC でも、ステップ 1 だけならすぐ動かせる。健闘を祈る。
